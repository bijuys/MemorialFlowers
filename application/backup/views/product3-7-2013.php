...
echo $product->alternate_text;?>"  title="<?php echo $product->alternate_text;?>" />
		...
		<p><em>Product Code: #<?php echo $product->product_code;?></em></p>
	    ...
	    <div id="tb-1">
			...
			<div class="clearfix">
				...
				<div class="product-item">
				     <center>
				       <div class="item">
					<a href="/<?php echo $upath.$row->url;?>" class="im"><img src="<?php echo img_resized('productres/'.$row->product_picture, '120x100');?>" alt="<?php
