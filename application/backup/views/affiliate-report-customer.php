...
<?php $gtotal=0.00; ?>
        <div id="content-wrapper">
            ...
            <div id="main" class="clearfix" >
                ...
                <?php } ?>
                <h2>Affiliate Reports - Customer Sales</h2>
                <table class="data_table" width="100%">
                    ...
                    <tbody>
                        ...
                        foreach($records as $row) {
                            ...
                            ?>
                        <tr>
                            <td align="left"><?php echo $row->user_firstname.' '.$row->user_lastname;?></td>
                            <td align="left"><?php echo $row->user_email;?></td>
                            <td align="center"><?php echo $row->purchases;?></td>
                            <td align="right"><?php echo '$'.number_format($row->orderamount,2);?></td>
