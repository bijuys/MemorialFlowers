					...
					<table width="100%" border="0">
						...
						<td width="80%" align="center">
							<a href="<?php echo base_url(); ?>">
								<img src="<?php echo base_url(); ?>images/mf-logo-new.png" width="90%" height="67" style="margin-top:5px;" />
							</a>
						</td>
						<td width="10">
			...
			<!-- Logo / Mobile Menu -->
				...
				<div class="col-sm-12 col-md-12 col-lg-2">
					...
					<a href="<?php echo base_url(); ?>" style="padding-left:20px;">
						...
						<img src="<?php echo base_url(); ?>images/mf-logo-new.png" width="75%" height="60" style="margin-top:5px;" />
					</a>
				</div>
