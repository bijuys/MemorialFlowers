...
<?php include_once("sidebar.php"); ?>
  <div id="contents-wrapper">
	...
	<tr>
          ...
          <option value="0"<?php if(($_POST && $_POST['banner_id']==0) || (isset($productgroup) && ($productgroup->banner_id=='0' || $productgroup->banner_id==''))) { echo 'selected="selected"'; } ?>>No Page</option>
