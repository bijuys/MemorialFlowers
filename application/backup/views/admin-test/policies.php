...
<?php include_once("sidebar.php"); ?>
  <div id="contents-wrapper">
    <h2>Policies <a href="<?=current_url();?>/create" class="button"><img src="/images/new.png" width="24" height="24" border="0" align="top" />Create</a>    </h2>
    <div id="shadow">
    <table border="0" align="center" cellpadding="0" cellspacing="0" id="result">
    <thead>
      <tr>
        <th width="5%">ID</th>
        <th width="70%">Policy</th>
        <th width="25%">Action</th>
      </tr>
      </thead>
      <tbody>
      <?php 
	  foreach($policies as $dval) : 
	  ?> 
      <tr>
