...
<?		
		   ...
		   IF(ISSET($_POST['submitsocialname'])){
				...
				$socialcontactperson = $_POST['socialcontactperson'];
			
				$socialcontacno = $_POST['socialcontactno'];
			
				$socialdescription = $_POST['socialdescription'];
				$socialcity = $_POST['socialcity'];
				$socialstate = $_POST['socialstate'];
				$socialemail = $_POST['socialemail'];
				
				
				$query3 = "INSERT INTO socialmedianame(socialtypename,description,socialcontactperson,socialcontactno,socialcity,socialstate,socialemail,startdate) VALUES ('$socialtypename','$socialdescription','$socialcontactperson','$socialcontactno','$socialcity','$socialstate','$socialemail','$startdate')";
				mysql_query($query3);
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
               ...
               <td width="50%" class="normaltext">Select a Customer</td>
                ...
                <!-- </select></td> 
					...
					<form name = "socialmedianame" action="<? echo current_url().'/add' ?>" method="post" enctype="multipart/form-data" >
					<hr>
					<table>
					<tr><td>
					Program Name : &nbsp; &nbsp;&nbsp; 
