...
<title>1-800-Flowers Administration Area</title>
...
<?php if(accessGrant('orders')) :?>
	      <li><a href="<?php echo FCBASE;?>/orders/browse">Orders</a>
			  <ul>
				  ...
				  <!-- <li><a href="<?php echo FCBASE;?>/order">Create New Order</a></li> //-->
			  </ul>
	      </li>
<?php endif;?>
...
<?php if(accessGrant('products') || accessGrant('addons') || accessGrant('categories') || accessGrant('subcategories') ||
	 ...
	 accessGrant('discounts') || accessGrant('currencies') || accessGrant('translation') || accessGrant('policies') ||
	 accessGrant('emails') || accessGrant('locationgroups') ||  accessGrant('countries') || accessGrant('provinces') || 
	  accessGrant('cities') || accessGrant('postalcodes') || accessGrant('holidays')) : ?>
	      <li><a href="#">Setup</a>
			  <ul>
