<?php include_once('header.php');?>
  ...
  <div id='homebox' style="height:220px;">
	...
	if($colo=='red'){
		$c1 = 'border:1px solid #A02422; background-color:#A02422; color:#fff; font-weight:bold; font-size:22px;';
	...
	if($colo=='white'){
		$c2 = 'border:1px solid #D9D9D9; background-color:#D9D9D9; color:#707070; font-weight:bold; font-size:22px;';
	...
	if($colo=='blue'){
		$c3 = 'border:1px solid #104E8B; background-color:#104E8B; color:#fff; font-weight:bold; font-size:22px;';
	...
	if($colo=='lavander'){
		$c4 = 'border:1px solid #8B668B; background-color:#8B668B; color:#fff; font-weight:bold; font-size:22px;';
	...
	if($colo=='pink'){
		$c5 = 'border:1px solid #FF82AB; background-color:#FF82AB; color:#fff; font-weight:bold; font-size:22px;';
	...
	if($colo=='bright'){
		$c6 = 'border:1px solid #FF7722; background-color:#FF7722; color:#fff; font-weight:bold; font-size:22px;';
	...
	if($colo=='pastel'){
		$c7 = 'border:1px solid #DB9EA6; background-color:#DB9EA6; color:#fff; font-weight:bold; font-size:22px;';
	...
	if($colo=='yellow'){
		$c8 = 'border:1px solid #FCDC3B; background-color:#FCDC3B; color:#fff; font-weight:bold; font-size:22px;';
	...
	if($colo=='peach'){
		$c9 = 'border:1px solid #D98719; background-color:#D98719; color:#fff; font-weight:bold; font-size:22px;';
        ...
        <div class="row-fluid" id="content" style="width:100%;">
          ...
          <div class="span19"style="width:100%;">
		   ...
		   <td style="height:20px;" width="78%">
			...
			<div style="margin-left:-25px; margin-bottom:-9px;">
		   ...
		   <td style="background-color:#A02422; padding: 0px 10px 0px 10px; font-size:25px; font-weight:bold; color:#fff; height:40px; <?php echo $d; ?>">
				Memorial Flowers <?php echo ucfirst($colo); ?> Collection
