...
<?php include_once('header.php'); ?>
  ...
  <?php if(isset($page) && $page->content_position=='top') { echo '<div id="pagecontents">'.rightLang($page->contents,$page->contents_fr).'</div>'; } ?> 
                <div id="main_content">
                <h2><?php echo lang('Delivery Details');?></h2>
                ...
                <div class="row-fluid item-section">
                    <div class="span6">
                        <h3><strong>Item <?php echo $icount;?>(#<?php echo $row->product_code; ?>)</strong></h3>
                        ...
                        <p class="lead"><?php echo $row->product_name; ?><?php echo lang('Item');?>
                        </p>                        
                    </div>
                    <div class="span12 form-horizontal">
                        ...
                        <div class="control-group <?php highlightclass(form_error("location_type[{$row->orderitem_id}]")); ?>">
                            ...
                            <div class="controls">
                                <select name="location_type[<?php echo $row->orderitem_id;?>]" id="location_type<?php echo $icount;?>" <?php highlight(form_error("location_type[{$row->orderitem_id}]")); ?>>
                                    <?php if($_POST)
                                            {
                ...
                <?php } ?>
                 <div class="buttons text-center">
                    ...
                    <button type="submit" name="checkout" id="checkout" value="" class="btn btn-large btn-inverse"><?php echo lang('Proceed with Checkout');?></button>
                </div>
                <?php echo form_close(); ?>
