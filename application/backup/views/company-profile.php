        ...
        <div id="content-wrapper">
            ...
            <div id="main" class="clearfix">
                ...
                <div class="entry_page clearfix">
                    ...
                    <h4>Make changes to the profile</h4>
                    <p>
                        <label for="business">Company Name<span class="mandatory">*</span></label>
                        <input type="text" name="business" id="business" value="<?php echo $_POST ? $p->business:(isset($user) ? $user->user_business:'');?>" size="30" />
                        <?php echo form_error("firstname"); ?>
                    </p>
                    <p>
                        <label for="firstname">Contact Person</label>
                        <input type="text" name="firstname" id="firstname" value="<?php echo $_POST ? $p->firstname:(isset($user) ? $user->user_firstname.' '.$user->user_lastname:'');?>" size="30" />
                        <?php echo form_error("firstname"); ?>
                    </p>
                    <p>
