        ...
        <div class="row-fluid" id="content" style="width:100%;">
          ...
          <div class="span19"style="width:100%;">
		   ...
		   <td style="height:20px;" width="78%">
			...
			<li style="display: inline; font-size:16px; <?php echo $c4; ?>"><a href="?col=lavender" style="text-decoration:none; color:inherit;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lavender&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
		   ...
		   <div style="margin-top:23px;">
			<a href="<?php echo base_url(); ?>occasion/flowers-for-cremation"><img src="<?php echo base_url(); ?>images/smallbanner1.png" style="height:240px; width:240px;" /></a>
			<br /><br />
			<a href="<?php echo base_url(); ?>occasion/flowers-for-home-and-office"><img src="<?php echo base_url(); ?>images/smallbanner2.png" style="height:240px; width:240px;" /></a>
		   </div>
		   ...
		   <td style="background-color:#A02422; <?php echo $d; ?> padding:10px 10px 3px 10px;">
				...
				<a href="<?php echo base_url(); ?>subcategory/<?php echo $colo; ?>"><img src="<?php echo base_url(); ?>images/memorial/<?php echo $colo; ?>.jpg" style="width:900px; height:435px;" /></a>
