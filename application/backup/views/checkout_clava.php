...
<!--start wrapper-->
	<section class="wrapper">
		...
		<section class="content about">
            ...
            <div id="stepi" class="row">
                <div class="text-center col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div id="banner-checkout">
                        <img src="<?php echo base_url('templates/clava/img/step3.jpg'); ?>" class="top-banner">
                    </div>
                </div>
            </div>          
  ...
  <?php if(isset($page) && $page->content_position=='top') { echo '<div id="pagecontents">'.rightLang($page->contents,$page->contents_fr).'</div>'; } ?>                     
     				 <div >
										<h2>
											<?php echo lang('Confirm your Order');?>
										</h2>										
					</div>			
...
-->                
       ...
       <div class="col-xs-12 col-md-4 col-lg-4 col-sm-4">       
       					<div class="dividerLatest">
							<h4><?php echo lang('Your Billing Information');?></h4>
							<div class="gDot"></div>
						</div>
                                      <p class="address">
                     ...
                     <div class="dividerLatest">
                        ...
                        <table cellpadding="3" cellspacing="0" class="table" border="0" >
                           ...
                           <tr>
                                ...
                                <td align="right">-<?php echo getRate($dist);
                         ...
                         //  }
                           ...
                           <tr>
                               ...
                               <td align="right">-<?php echo getRate($totals['companyless']);?></td>
                           </tr> 
                           <?php
                           }
                           ...
                           <tr>
                               <td style="vertical-align:middle;"><strong><?php echo lang('Grand Total');?></strong></td>
                               <td align="right"><span style="font-size:22px;"><?php echo getRate($totals['grandtotal']);?></span></td>
                           </tr>
                        </table>          
                        <br />
       ...
       <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
       				<div class="dividerLatest">
							<h4><?php echo lang('Your Item(s)');?></h4>
							<div class="gDot"></div>
						</div>
...
<table border="0" cellpadding="15" cellspacing="0" class="table" >
					   ...
					   <p style="display: block; float: none;">
                            ...
                            <input type="hidden" name="company_pay" value="1" />
                             <input type="hidden" name="nameoncard" id="nameoncard" value="cardtest" size="30" />
                             <input type="hidden" name="cardtype" id="nameoncard" value="visa" size="30" />
                             <input type="hidden" name="cardnumber" id="nameoncard" value="4111111111111111" size="30" />
                             <input type="hidden" name="expiry_month" id="nameoncard" value="01" size="30" />
                             <input type="hidden" name="expiry_year" id="nameoncard" value="2016" size="30" />
                             <input type="hidden" name="cvv" id="nameoncard" value="111" size="30" />
                    ...
                    {
                    ?>       
                         <div class="form-warning" style="font-weight: 600; color:#EF2D2D;">
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="nameoncard" value="<?php echo $billing->firstname.' '.$billing->lastname;?>" id="nameoncard" class="nameoncard form-control" />
	  [<small><a href="#" class="editinline"><?php echo lang('Edit');?></a></small>]
								</div>
							</div>
							<br />
							<div class="control-group <?php highlightclass(form_error("cardnumber")); ?>">
								...
								<div class="controls">
									<input type="text" name="cardnumber" id="cardnumber" maxlength="16" value="<?php if($_POST) echo $_POST['cardnumber'];?>" size="30" class="form-control"/>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="control-group">
										...
										<div class="controls">
											<select name="expiry_month" id="expiry_month" class="form-control" <?php highlight(form_error("expiry_month")); ?>>
								...
								<div class="col-lg-6">
									<div class="control-group">
										<label for="expiry_month" class="control-label"><?php echo lang('Card Expiry');?><span class="mandatory">*</span></label>
										<div class="controls">
											<select name="expiry_year" id="expiry_year" class="form-control" <?php highlight(form_error("expiry_year")); ?>>
							...
							<div class="control-group<?php highlightclass(form_error("cvv")); ?>">
										...
										<div class="controls">
											<input type="text" name="cvv" id="cvv" class="form-control" value="<?php if($_POST) echo $_POST['cvv'];?>" size="5" maxlength="4"  /> &nbsp;
             ...
             <div class="clearfix">	</div>
                ...
                <div class="text-center">
                    ...
                    <button type="submit" name="paynow" id="paynow" value="<?php echo lang('Pay Now');?>"  class="btn btn-large btn-default" onClick="return Loginvalid();"><?php echo lang('Pay Now');?></button>
                </div>
