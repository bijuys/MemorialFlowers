...
<?php include_once("sidebar.php"); ?>
  <div id="contents-wrapper">
   ...
   <!-- <select name="city" id="city"> 
	...
	<?php if(count($gen_orders)): ?>
    <div id="shadow">
	<br />
	<span style="font-size: 30px; font-weight:bold; color:#8B1A1A;">
	<?php echo 'Orders Distribution for ';
	if($provin == 'ON'){
		 echo 'Ontario';
		}
		if($provin == 'PQ'){
    ...
    <thead>
	  ...
	  <?php $i=0; foreach($gen_orders_lo as $row2) : 
	  ...
	  <?php $j=0;
	  foreach($gen_orders_ds as $row3) : 
	  if($row->city == $row3->city){?> 
