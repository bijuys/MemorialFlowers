			...
			<div class="container">
				<div class="row" id="responsive">
					<div class="col-sm-12 col-md-4 col-lg-4">
						<a href="<?php echo base_url(); ?>occasion/flowers-for-service">
							<img src="<?php echo base_url(); ?>images/MF-tile-funeral-3.jpg" width="100%" style="border:1px solid #999999;" />	
						</a>
					</div>
					<div class="col-sm-12 col-md-4 col-lg-4">
						<a href="<?php echo base_url(); ?>occasion/flowers-for-home-and-office">
							<img src="<?php echo base_url(); ?>images/MF-tile-homeandoffice-3.jpg" width="100%" style="border:1px solid #999999;" />	
						</a>
					</div>
					<div class="col-sm-12 col-md-4 col-lg-4">
						<a href="<?php echo base_url(); ?>category/fruit-baskets">
							<img src="<?php echo base_url(); ?>images/MF-tile-gourmet-3.jpg" width="100%" style="border:1px solid #999999;" />	
						</a>
					</div>
				</div>
				...
				<div class="row" id="mobile-header">
					<div class="col-lg-12" style="margin-bottom:5px;">
						<a href="<?php echo base_url(); ?>occasion/flowers-for-service">
							<img src="<?php echo base_url(); ?>images/MF-tile-funeral-3.jpg" width="100%" style="border:1px solid #8D0352;" />	
						</a>
					</div>
					<div class="col-lg-12" style="margin-bottom:5px;">
						<a href="<?php echo base_url(); ?>occasion/flowers-for-home-and-office">
							<img src="<?php echo base_url(); ?>images/MF-tile-homeandoffice-3.jpg" width="100%" style="border:1px solid #8D0352;" />	
						</a>
					</div>
					<div class="col-lg-12" style="margin-bottom:5px;">
						<a href="<?php echo base_url(); ?>category/fruit-baskets">
							<img src="<?php echo base_url(); ?>images/MF-tile-gourmet-3.jpg" width="100%" style="border:1px solid #8D0352;" />	
						</a>
					</div>	
