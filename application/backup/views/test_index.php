        ...
        <div class="row-fluid" id="content" style="width:100%;">
          ...
          <div class="span19"style="width:100%;">
		   ...
		   <div style="margin-top:23px;">
			<a href="occasion/flowers-for-cremation"><img src="<?php echo base_url(); ?>images/smallbanner1.png" style="height:240px; width:240px;" /></a>
			<br /><br />
			<a href="occasion/flowers-for-home-and-office"><img src="<?php echo base_url(); ?>images/smallbanner2.png" style="height:240px; width:240px;" /></a>
		   </div>
		   ...
		   <td style="background-color:#A02422; <?php echo $d; ?> padding:10px 10px 3px 10px;">
				...
				<a href="subcategory/<?php echo $colo; ?>"><img src="<?php echo base_url(); ?>images/memorial/<?php echo $colo; ?>.jpg" style="width:900px; height:435px;" /></a>
