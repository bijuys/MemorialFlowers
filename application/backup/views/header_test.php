					...
					<table width="100%" border="0">
						...
						<td width="80%" align="center">
							<a href="<?php echo base_url(); ?>">
								<img src="<?php echo base_url();?>/images/templates/<?php echo $template->folder; ?>/<?php echo $template->logo; ?>" width="90%" height="67" style="margin-top:5px;" />
							</a>
						</td>
						<td width="10">
			...
			<!-- Logo / Mobile Menu -->
				...
				<div class="col-sm-12 col-md-12 col-lg-2">
					...
					<a href="<?php echo base_url(); ?>" style="padding-left:20px;">
						...
						<!--<img src="<?php echo base_url(); ?>images/mf-logo-pink-big.png" height="70" style="margin-top:10px;" />-->
						<img src="<?php echo base_url();?>/images/templates/<?php echo $template->folder; ?>/<?php echo $template->logo; ?>" width="75%" height="60" style="margin-top:5px;" />
					</a>
				</div>
				
				<div id="carrito" class="col-sm-12 col-md-12 col-lg-1">
					<div class="row">
