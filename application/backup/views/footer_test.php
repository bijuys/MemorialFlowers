				...
				<div class="col-sm-4 col-md-4 col-lg-4" style="padding-top:10px;display:none;">
					<div class="sw_search">                            
						...
						<div class="site-search-area">
							<form method="post" id="site-searchform" action="<?php echo base_url('support/subscribe');?>">
					...
					<div class="widfoot_content">
						<ul class="links">
							<li>
								...
								<a href="<?php echo base_url('subcategory/bouquets');?>" style="font-weight:normal;">Bouquets</span></a>
							</li>
							<li>
								<i class="fa fa-caret-right"></i> 
								<a href="<?php echo base_url('subcategory/standing-sprays');?>" style="font-weight:normal;">Standing Sprays </span></a>
							</li> 																	                            
							<li>
								<i class="fa fa-caret-right"></i> 
								<a href="<?php echo base_url('subcategory/sympathy-baskets');?>" style="font-weight:normal;">Sympathy Baskets</span></a>
							</li>                            
							<li>
								<i class="fa fa-caret-right"></i> 
								<a href="<?php echo base_url('occasion/flowers-for-service');?>" style="font-weight:normal;">Flowers For Service</span></a>
							</li>                           
						</ul>
					</div>
				</div>
				<div class="col-sm-3 col-md-3 col-lg-3">
					...
					<div class="widfoot_content">
						<ul class="links">
							...
							<li>
								<i class="fa fa-caret-right"></i> 
								<a href="<?php echo base_url('support/tracking');?>" style="font-weight:normal;">Order Tracking</span></a>
							</li>
							-->
							<li>
								<i class="fa fa-caret-right"></i> 
								<a href="<?php echo base_url('contact');?>" style="font-weight:normal;">Contact Us</span></a>
							</li>
							<li>
								<i class="fa fa-caret-right"></i> 
								<a href="<?php echo base_url('faqs');?>" style="font-weight:normal;">FAQs</span></a>
							</li>	
							<li>
								<i class="fa fa-caret-right"></i> 
								<a href="<?php echo base_url('terms-of-use');?>" style="font-weight:normal;">Terms Of Use</span></a>
							</li> 
							<li>
								<i class="fa fa-caret-right"></i> 
								<a href="<?php echo base_url('privacy-and-security');?>" style="font-weight:normal;">Privacy and Security Policies</span></a>
							</li> 							
						</ul>
					</div>
				</div>
				<div class="col-sm-3 col-md-3 col-lg-3">
					...
					<div class="widfoot_content">
						<ul class="links">
							<li>
								<i class="fa fa-caret-right"></i> 
								<a href="<?php echo base_url('mymemorial');?>" style="font-weight:normal;">Affiliate Login</span></a>
							</li>
						</ul>
					</div>
				</div>
