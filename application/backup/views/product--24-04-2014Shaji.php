...
echo $product->alternate_text;?>"  title="<?php echo $product->alternate_text;?>" />
	...
	<div class="span16">	 
		...
		<div class="row-fluid">
			...
			<div id="selddates">
			    <h4><?php echo lang('Please select a delivery time');?></h4>
			    
			    <select name="upcoming_time" id="upcoming_time" style="width:185px; vertical-align:top;">
			...
			<p class="showing_date"><label><?php echo lang('Delivery');?>: <input type="text" id="show_date" readonly="readonly"  size="30" style="background:transparent; border: none; box-shadow: none; font-size:20px; font-weight:bold;" value="" /></label></p>
