            ...
            <div id="main_content" >
             <h2><?php echo lang('Confirm your Order');?></h2>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span6">
                        <h3><?php echo lang('Your Billing Information');?></h3>
                        <p class="address">
                    ...
                    <div class="span12 offset1">
                        ...
                        <td>
                            <p>
                            <em><?php echo lang('Ships to');?>:</em>(<?php echo lang($item->location_type);?>)<br/>
                       ...
                       <div class="form-warning">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="nameoncard" value="<?php echo $billing->firstname.' '.$billing->lastname;?>" id="nameoncard" class="nameoncard" />  [<small><a href="#" class="editinline"><?php echo lang('Edit');?></a></small>]
                            </div>
                        </div>
                        <script>
                        ...
                        <div class="control-group <?php highlightclass(form_error("cardnumber")); ?>">
                            ...
                            <div class="controls">
                                <input type="text" name="cardnumber" id="cardnumber" maxlength="16" value="<?php if($_POST) echo $_POST['cardnumber'];?>" size="30" />
                        ...
                        <div class="control-group<?php highlightclass(form_error("cvv")); ?>">
                            ...
                            <div class="controls">
                                <input type="text" name="cvv" id="cvv" class="input-mini" value="<?php if($_POST) echo $_POST['cvv'];?>" size="5" maxlength="4" /> &nbsp;
                ...
                <div class="text-center">
                    ...
                    <button type="submit" name="paynow" id="paynow" value="<?php echo lang('Pay Now');?>" class="btn btn-large btn-inverse" ><?php echo lang('Pay Now');?></button>
                </div>
