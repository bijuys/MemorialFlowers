...
<?php echo lang('Total');?>: <span id="cart-total"></span></span><button class="next btn btn-success" id="step-one"><?php echo lang('Next Step');?></button></div>
			...
			<script type="text/javascript">
				...
				function displayDiv(id,sel){
					...
					//alert(i);
					/*alert('ID number: ' + i);
					alert('Return value of gEBI: ' + document.getElementById('div' + i));*/
					/*var sand='div';
					var df=(sand+i);
					...
					/*var a = 10;
					var b = 20;
				var s=	console.log('result is ' + a + b);
alert(s);*/
					
					 
					 var div2 = document.getElementById(id+sel.selectedIndex);
				 ...
				 <div class="control-group">
                      ...
                      <div class="controls">
                        ...
                        <select id="locationtype" name="locationtype" onChange="displayDiv('div',this)">
					 ...
					 ?>
                          <option value="<?php echo $getloc_type_rows['name']; ?>" ><?php echo $getloc_type_rows['name']; ?></option>
				...
				<?php 
					...
					$getloc_type_result2 = mysqli_query($con,"SELECT * from affiliate_locations where affiliate_id=".$this->session->userdata('affiliate_id')." order by location_id ASC");
						$ii = 0;
				...
				?>
					...
					<div id="div<?php echo $ii?>" name="div<?php echo $ii?>" <?php echo $hi; ?> >
                  ...
                  <div class="formcol2 form-horizontal">
                    ...
                    <div class="control-group">
                      ...
                      <select name="country_id" id="country_id">
                        ...
                        if($getloc_type_rows2['country'])
                        {
                          if($getloc_type_rows2['country']==$country->country_id)
                          {
                            echo ' selected="selected" ';
                          }
                        }
