...
<?php include_once(APPPATH.'views/mymemorial-header.php'); ?>
                ...
                <div class="span12">
                    <table border="0" cellpadding="15" cellspacing="0" class="table" >
                        ...
                        <td>
                         ...
                         <p><em><?php echo lang('Sent On');?>:</em> <strong><?php echo date('l d M Y',strtotime($item->delivery_date)).' : '.$item->delivery_time;?></strong></p>
            ...
            <p class="text-center"><small><a href="<?php echo site_url();?>/mymemorial"><?php echo lang('Back to Home');?></a></small></p>
            </div>
