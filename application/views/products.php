            ...
            <div id="page" class="row">
				...
				<div id="responsive" class="col-sm-12">
                          <div class="row products-navigation" style="margin-left:0px;margin-right:0px;">
                                  <div class="col-sm-9">
                                      <!--<h1 class="heading"><span style="font-size:20px;padding-left:5px;"><a href="<?php echo base_url(); ?>">Home</a> > <?php echo $location.' > '.$val; ?></span></h1>-->
                                      <span class="heading" style="font-size:20px;padding-left:5px;"><a href="<?php echo base_url(); ?>">Home</a> > <?php echo $val; ?></span>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 ...
                 <div class="col-sm-9">
					...
					-->	
                          ...
                          <div class="row" id="products-listing">
								...
								<?php if($procount>=$n1 && $procount<=$n2){ ?>
