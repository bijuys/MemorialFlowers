...
<?php include_once("sidebar.php"); ?>
  ...
  <div id="contents-wrapper">
    <h2>City Pages SEO Content <a href="<?php echo current_url(); ?>/create" class="button"><img src="/images/new.png" width="24" height="24" border="0" align="top" />Create New</a>    </h2>
