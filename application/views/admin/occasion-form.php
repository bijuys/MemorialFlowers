...
<?php include_once("sidebar.php"); ?>
  <div id="contents-wrapper">
	...
	<tr>
          ...
          <option value="0" <?php if(($_POST && $_POST['page_id']==0) || (isset($occasions) && ($occasions->page_id=='0' || $occasions->page_id==''))) { echo 'selected="selected"'; } ?>>No Page</option>
          <?php foreach($pages as $page)
          { ?>
          <option value="<?php echo $page->page_id;?>" <?php if(($_POST && $_POST['page_id']==$page->page_id) || (isset($occasions) && $occasions->page_id==$page->page_id)) { echo 'selected="selected"'; } ?>><?php echo $page->page_name;?></option>
          <?php } ?>          
          </select>    
          </td>
        </tr>
