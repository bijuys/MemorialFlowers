...
<?php include_once("sidebar.php"); ?>
  <div id="contents-wrapper">
    ...
    <div id="shadow">
      <table border="0" align="center" cellpadding="0" cellspacing="0" id="form_table">
        ...
        <tr>
          ...
          <td><input name="productgroup_link" type="text" id="productgroup_link" value="<?php echo set_value('productgroup_link',isset($productgroup)?$productgroup->productgroup_link:''); ?>" size="40" /></td>
        </tr>
        <tr>
        ...
        <tr>
         <td valign="top" class="label">Assign Products</td>
          <td><div class="scroll_win" style="height:350px; width:480px;">
		...
		foreach($products as $row):
	      ?>
              <tr>
                <td><input name="products[]" type="checkbox"  value="<?php echo $row->product_id;?>"
				 ...
				 ?>/></td>
				 <td nowrap="nowrap"><img src="<?php echo base_url(); ?>productres/<?php echo $row->product_picture; ?>" height="50" width="50" /></td>
				 
                <td nowrap="nowrap"><?php echo $row->product_name; ?></td>
				<td nowrap="nowrap">
				
				
				<input name="product_order[<?php echo $row->product_id;?>]" type="text" style="width:40px;" id="product_order[<?php echo $row->product_id; ?>]" value="<?php echo $row->orderby; ?>"
    ...
    <tr>
	  ...
	  <td><input type="checkbox" name="productgroup_status" value="1" <?php if($_POST) { echo isset($_POST['publish_post']) ? ' checked="checked" ':''; } elseif(isset($productgroup)) { echo $productgroup->productgroup_status==1 ? ' checked="checked" ':''; } ?> id="productgroup_status" /></td>
	</tr>
