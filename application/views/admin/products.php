...
?>
  <div id="contents-wrapper">
    <h2>Products <a href="<?php echo current_url(); ?>/create" class="button"><img src="/images/new.png" width="24" height="24" border="0" align="top" />Create New</a>    </h2>
...
<div class="filter-options" style="text-align:center;">
    ...
    <thead>
      <tr>
        ...
        <th width="25%" align="center">Product Color</th>
      ...
      <tr>
		...
		<td class="left">
			...
			<select id="product_color" name="product_color" onChange="changeColorSe(this.value,'<?php echo $row->product_id; ?>');">
				<option value="">Select Color</option>
				<option value="Blue" <?php if($row->color=="Blue"){ echo 'selected="selected"'; } ?>>Blue</option>
				<option value="Lavender" <?php if($row->color=="Lavender"){ echo 'selected="selected"'; } ?>>Lavender</option>
				<option value="Pink" <?php if($row->color=="Pink"){ echo 'selected="selected"'; } ?>>Pink</option>
				<option value="Pastel" <?php if($row->color=="Pastel"){ echo 'selected="selected"'; } ?>>Pastel</option>
				<option value="White" <?php if($row->color=="White"){ echo 'selected="selected"'; } ?>>White</option>
				<option value="Yellow" <?php if($row->color=="Yellow"){ echo 'selected="selected"'; } ?>>Yellow</option>
				<option value="Peach" <?php if($row->color=="Peach"){ echo 'selected="selected"'; } ?>>Peach</option>
				<option value="Red" <?php if($row->color=="Red"){ echo 'selected="selected"'; } ?>>Red</option>
			</select>
