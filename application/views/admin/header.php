...
<title>Memorial Flowers Administration Area</title>
...
<link rel="stylesheet" type="text/css" href="<?php echo theme_url();?>/admin/style.css" />
<link href="<?php echo theme_url();?>/admin/superfish.css" rel="stylesheet" type="text/css" />
...
<div id="header">
  <h1><img src="/templates/dignity/img/dignityflowers-logo-213x45.png" /></h1>
...
<li><a href="<?php echo FCBASE;?>">SEO Tools</a>
			  <ul>
			   
					 
                     
				     <li><a href="#">National Overview</a>
                     
                     	<ul>
                        <li><a href="<?php echo FCBASE;?>/pages/edit/8">Home</a></li>
                        <!--<li><a href="<?php //echo FCBASE;?>/pages/menus">Menus</a></li>-->
                        <li><a href="<?php echo FCBASE;?>/productgroups/landing">Landing Pages</a></li>
                        </ul>
                     
                     </li>
                     <li><a href="#">Cities Overview</a>
                     
                     	<ul>
                        <li><a href="<?php echo FCBASE;?>/landing">Home</a></li>
                        <li><a href="#">Menus</a></li>
                        <li><a href="#">Landing Pages</a></li>
                        </ul>
                     
                     </li>
                     <li><a href="<?php echo FCBASE;?>/keywords">Keywords</a></li>
...
<?php endif; ?>
							<li><a href="<?php echo FCBASE;?>/products/locations">Products Locations</a></li>
							<li><a href="<?php echo FCBASE;?>/products/merchandise">Products Merchandise</a></li>
					  </ul>  
				  </li>
...
<?php endif; // if(accessGrant('socialmedia')) :?>
				  ...
				  <li><a href="<?php echo FCBASE;?>/socialdeals">New Social Media</a></li>						  
			  ...
			  <ul>
			    <!--
				  ...
				  <li><a href="<?php echo FCBASE;?>/reports/wizard">New Reports</a>
				       <ul>
					//-->
					 <li><a href="<?php echo FCBASE;?>/orders/cities">City Based Report</a></li>
