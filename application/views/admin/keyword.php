...
<?php include_once("sidebar.php"); ?>
  ...
  <div id="contents-wrapper">
    <h2>Keyword Folders<a href="<?php echo current_url(); ?>/create" class="button"><img src="/images/new.png" width="24" height="24" border="0" align="top" />Create New</a>    </h2>
...
<div class="filter-options" style="text-align:center; visibility:hidden;">
    ...
    <thead>
      <tr>
        ...
        <th width="25%" align="center">Folder Name</th>
        <th width="25%" align="center">Keyword Link</th>
      ...
      <tr>
        <td><?php echo $row->folder_id;?>
            
        </td>
        
       
        <td class="left"><?php echo $row->folder_name;?></td>
        <td class="left"><?php echo $row->folder_link;?></td>
    ...
    <?php endif; ?>
    <p class="back"><a href="<?php echo FCBASE;?>/landing/keywords" class="button"><img src="/images/back.png" border="0" align="absmiddle" /> Back</a></p>
  </div>
    <div class="clear"></div>
