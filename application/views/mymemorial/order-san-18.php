        ...
        if (req) {
            ...
            req.send(null);
				 ...
				 <div class="control-group">
                    ...
                    ?>
                    <select name="locationtype" id="locationtype" onChange="getCity('details.php?name='+this.value)">
					...
					<div id="citydiv">
                     <?php   $sqls = mysqli_query($con,"SELECT * from affiliate_locations where location_id=9");
                   ...
                   <div class="formcol1 form-horizontal">     
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                       <?php  echo '<input type="text" name="lastname" size="30" id="lastname" value="'.$rs['contact_lastname'].'"/>'; ?>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                       <?php  echo '<input type="text" name="phone" size="30" id="phone" value="'.$rs['phone'].'"  />'; ?>
					 ...
					 <div class="control-group">
                      ...
                      <div class="controls">
                       <?php  echo '<input type="text" name="address" size="30" id="address" value="'.$rs['address'].'"  />'; ?>
                  ...
                  <div class="formcol2 form-horizontal">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        ...
                        <?php  echo '<input type="text" name="postalcode" size="30" id="postalcode" value="'.$rs['postalcode'].'"  />'; ?>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                         <?php  echo '<input type="text" name="city" id="city"  size="30" value="'. $rs['city'].'"  />';?>
                      </div>
                    </div>
                    <div class="control-group">
                      ...
                      <?php $sql3 = mysqli_query($con,"SELECT * from provinces  where  country_id=".$rs['country']);
					 // echo $rs['province'];
