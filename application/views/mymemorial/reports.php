<?php include_once(APPPATH.'views/mymemorial-header.php'); ?>
	...
	<div id="content" class="clearfix">
		...
		<span style="color:#770922;font-size:30px;">Reports</span>
		<br /><br />
							...
							<table width="100%">
								<tr>
									...
									<td width="15%">
										...
										<input type="text" name="datepicker1" id="datepicker1" class="search-query" style="width:72%;" required>
										<input type="hidden" name="funeral_home" id="funeral_home" value="" class="search-query" style="width:72%;">
									</td>
									<td width="15%">
										<label>End date</label>
										<input type="text" name="datepicker2" id="datepicker2" class="search-query" style="width:72%;" required>
									</td>
									<td width="15%">
    ...
    <div class="clearfix" id="dash" style="display:none;">
      <div id="content" class="clearfix">
        <div id="page">
