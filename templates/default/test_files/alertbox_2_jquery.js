...
jQuery.fn.sandelay = function(time,func){
  ...
  popup = {
    ...
    replaceBox: function() {
      if(this.options.display == 1) {
        ...
        $(this).sandelay(this.options.moveDuration, $.bind(this, function() {
          $('#BoxAlertBtnOk').focus();
    ...
    display: function(option) {
      if(this.options.display == 0 && option != 0 || option == 1) {
        ...
        $(this).sandelay(500, $.bind(this, this.queue));
    ...
    messageBox: function(type, message, properties, input) {
        ...
        {
			 $('#'+this.options.name+'-Buttons').append('<input id="BoxConfirmBtnOk" type="submit" onclick="bhupinder()"/>');

            //$('#'+this.options.name+'-Buttons').append('<input id="BoxConfirmBtnOk" type="submit" onclick="bhupinder()"/> <input id="BoxConfirmBtnCancel" type="submit" />');
